...
For now only simple messages can be converted into XML. Any *help* is greatly *appreciated*. You can find working (more or less) examples in src/examples/java.
